...
export const lessons: Lesson[] = [
  {
    ...
    slug: 'what-is-rcm',
    title: 'What is RCM?',
    subtitle: 'Understanding the fundamentals of Reliability Centred Maintenance',
    duration: '15-20 min',
    content: `
## The Origins of RCM
...
In the next lesson, we'll dive into the heart of RCM: the seven questions that drive every analysis.
    `,
    keyTakeaways: [
      'RCM originated in aviation during the 1960s-70s to address ineffective maintenance strategies',
      'Only 11% of equipment shows age-related wear patterns—most failures are random',
      'John Moubray\'s "RCM II" adapted the methodology for industrial applications',
      'SAE JA1011 defines the standard criteria any RCM process must meet',
      'RCM focuses on preserving function, not just preventing failures',
    ],
    quiz: [
      {
        question: 'What percentage of equipment was found to exhibit age-related failure patterns in Nowlan and Heap\'s research?',
        options: ['50%', '89%', '11%', '25%'],
        correctIndex: 2,
        explanation: 'Nowlan and Heap discovered that only 11% of equipment exhibited age-related failure patterns. The remaining 89% showed random or infant mortality patterns, challenging traditional time-based maintenance assumptions.',
      },
      {
        question: 'What does SAE JA1011 define?',
        options: [
          'The best maintenance software to use',
          'How often to perform maintenance',
          'Minimum criteria for a process to be called RCM',
          'A list of approved RCM consultants',
        ],
        correctIndex: 2,
        explanation: 'SAE JA1011 defines the evaluation criteria—the minimum requirements a process must meet to be legitimately called Reliability Centred Maintenance.',
      },
      {
        question: 'Who wrote the definitive industrial RCM book "RCM II"?',
        options: ['Stan Nowlan', 'Howard Heap', 'John Moubray', 'Henry Ford'],
        correctIndex: 2,
        explanation: 'John Moubray published "RCM II: Reliability-centered Maintenance" in 1991, adapting aviation RCM principles for industrial applications.',
      },
      {
        question: 'What is the primary focus of RCM?',
        options: [
          'Reducing maintenance costs at any expense',
          'Preserving system function',
          'Replacing equipment before it fails',
          'Eliminating all maintenance tasks',
        ],
        correctIndex: 1,
        explanation: 'RCM focuses on preserving system function—ensuring equipment continues to do what users need it to do within its operating context.',
      },
    ],
  },
  {
    id: 2,
    slug: 'seven-rcm-questions',
    title: 'The 7 RCM Questions',
    subtitle: 'The systematic framework that drives every RCM analysis',
    duration: '20-25 min',
    content: `
## The Heart of RCM
...
In the next lesson, we'll take a deeper dive into failure modes and effects analysis—where most of the analytical work happens.
    `,
    keyTakeaways: [
      'The 7 RCM questions must be answered in sequence—no shortcuts',
      'Functions must include performance standards to be meaningful',
      'Failure modes should be specific enough to identify appropriate tasks',
      'Consequences are categorised: hidden, safety/environmental, operational, non-operational',
      'Not every failure needs preventing—run-to-failure is sometimes the right answer',
    ],
    quiz: [
      {
        question: 'What must a complete function statement include?',
        options: [
          'Just the equipment name',
          'A verb, object, and performance standard',
          'The maintenance schedule',
          'The equipment cost',
        ],
        correctIndex: 1,
        explanation: 'A function statement must include a verb (what the item does), an object (what it acts upon), and a performance standard (how well it must do it). Without all three, you can\'t properly assess whether the function is being fulfilled.',
      },
      {
        question: 'What are the four categories of failure consequences in RCM?',
        options: [
          'Minor, moderate, major, catastrophic',
          'Hidden, safety/environmental, operational, non-operational',
          'Predictable, random, sudden, gradual',
          'Mechanical, electrical, hydraulic, pneumatic',
        ],
        correctIndex: 1,
        explanation: 'RCM categorises failure consequences as: Hidden (not evident under normal operation), Safety/Environmental, Operational (affects production/quality), and Non-operational (only repair costs matter).',
      },
      {
        question: 'When is "run to failure" an acceptable maintenance strategy?',
        options: [
          'Never—all failures must be prevented',
          'Only when no other option exists',
          'When failure consequences are acceptable and no cost-effective prevention exists',
          'Only for brand new equipment',
        ],
        correctIndex: 2,
        explanation: 'Run to failure is a legitimate RCM strategy when the consequences of failure are acceptable (non-operational or some operational) and no proactive task is worth doing. It\'s a conscious decision, not neglect.',
      },
      {
        question: 'What type of maintenance task is used specifically for hidden failures?',
        options: [
        ...
        correctIndex: 2,
        explanation: 'Failure-finding tasks are periodic checks that confirm hidden functions still work (like testing backup systems or safety devices). They\'re specifically designed for failures that wouldn\'t be evident during normal operation.',
      },
      {
        question: 'Why must the 7 RCM questions be asked in sequence?',
        options: [
          'To save time',
          'Because SAE JA1011 requires it as a formality',
          'Each question builds on information from the previous answers',
          'To make documentation easier',
        ],
        correctIndex: 2,
        explanation: 'The questions follow a logical sequence where each answer informs the next. You can\'t assess consequences without knowing failure effects, and you can\'t select tasks without understanding consequences.',
      },
    ],
  },
  {
    id: 3,
    slug: 'failure-modes-effects',
    title: 'Understanding Failure Modes & Effects',
    subtitle: 'The analytical core of RCM—where the real work happens',
    duration: '25-30 min',
    content: `
...
In the next lesson, we'll explore the RCM Decision Diagram—the tool that formalises this task selection process.
    `,
    keyTakeaways: [
      'Failure modes must be single events at the right level of detail—not too vague, not too specific',
      'Failure effects must include evidence, operational impact, secondary damage, and repair requirements',
      'Use multiple sources: equipment history, manufacturers, databases, and expert knowledge',
      'Focus on "reasonably likely" failure modes for your specific operating context',
      'Good FMEA makes maintenance task selection straightforward',
    ],
    quiz: [
      {
        question: 'Which of the following is a properly stated failure mode?',
        options: [
          'Pump fails to deliver required flow',
          'Bearing seizes due to lubricant contamination',
          'Equipment stops working',
          'Multiple mechanical problems',
        ],
        correctIndex: 1,
        explanation: '"Bearing seizes due to lubricant contamination" is specific enough to identify a maintenance approach. The other options are either too vague or describe functional failures rather than failure modes.',
      },
      {
        question: 'What should a complete failure effect statement include?',
        options: [
          'Only the immediate symptom',
          'Evidence, operational impact, secondary damage, and repair requirements',
          'Just the cost of repair',
          'Only what the operator should do',
        ],
        correctIndex: 1,
        explanation: 'A complete failure effect statement includes: evidence of failure (what operator notices), impact on operations, secondary damage, and repair requirements. This information is essential for assessing consequences.',
      },
      {
        question: 'Why should you validate generic failure mode databases for your context?',
        options: [
          'Because they\'re usually wrong',
          'Operating conditions and equipment configurations vary—generic lists are starting points, not gospel',
          'To reduce the number of failure modes',
          'Because regulators require it',
        ],
        correctIndex: 1,
        explanation: 'Generic databases provide useful starting points, but your specific operating context (environment, duty cycle, process fluid, etc.) affects which failure modes are relevant and how they manifest.',
      },
      {
        question: 'What is the "Goldilocks zone" for failure mode detail?',
        options: [
          'As detailed as possible',
          'As brief as possible',
          'Specific enough to identify maintenance approaches but not excessively detailed',
          'Whatever the manufacturer recommends',
        ],
        correctIndex: 2,
        explanation: 'Failure modes need to be at the right level—specific enough to determine an appropriate maintenance task, but not so detailed you\'re specifying metallurgical failure mechanisms.',
      },
    ],
  },
  {
    ...
    title: 'The RCM Decision Diagram',
    subtitle: 'Selecting the right maintenance task for each failure mode',
    duration: '20-25 min',
    content: `
...
**The economic question**: Would spending £X on this maintenance task save more than £X in avoided failure costs? If not, run to failure may be the right answer.
...
4. **Is an on-condition task feasible and economic?** 
   ...
   - Economic: Inspection cost × frequency vs. failure cost × probability
...
In our final lesson, we'll cover how to implement RCM in your organisation—turning analysis into action.
    `,
    keyTakeaways: [
      'The decision diagram ensures consistent, logical task selection based on failure consequences',
      'Hidden failures require failure-finding tasks to detect dormant problems',
      'Safety/environmental failures must have proactive tasks or require redesign—run-to-failure is not acceptable',
      'Economic justification is required for operational and non-operational failure tasks',
      'No scheduled maintenance is a legitimate outcome when consequences are acceptable',
    ],
    quiz: [
      {
        question: 'What makes a failure "hidden"?',
        options: [
          'It happens inside the equipment',
          'It\'s not evident to operating crew under normal circumstances',
          'It\'s too small to see',
          'It happens at night',
        ],
        correctIndex: 1,
        explanation: 'Hidden failures are those that won\'t be noticed under normal operating conditions—like a backup pump that doesn\'t run until the primary fails, or a safety device that only activates during emergencies.',
      },
      {
        question: 'For a failure with safety consequences, what happens if no proactive maintenance task is feasible?',
        options: [
        ...
        correctIndex: 2,
        explanation: 'For safety/environmental consequences, you cannot simply accept the failure. If no proactive task can reduce risk to acceptable levels, redesign to eliminate or mitigate the hazard is mandatory.',
      },
      {
        question: 'What is the P-F interval?',
        options: [
          'The time between purchases',
          'The period from potential failure (detectable degradation) to functional failure',
          'The planned failure interval',
          'The production floor interval',
        ],
        correctIndex: 1,
        explanation: 'The P-F interval is the time between when deterioration becomes detectable (potential failure, P) and when functional failure occurs (F). On-condition task intervals must be shorter than this to catch failures in time.',
      },
      {
        question: 'When is "no scheduled maintenance" (run to failure) an appropriate outcome?',
        options: [
          'Never—all equipment needs maintenance',
          'When consequences are operational or non-operational and no cost-effective proactive task exists',
          'Only for brand new equipment',
          'When budget is limited',
        ],
        correctIndex: 1,
        explanation: 'Run to failure is legitimate when failure consequences are acceptable (operational or non-operational) and no proactive task is technically feasible or economically justified.',
      },
      {
        question: 'What type of task is specifically used for hidden failures?',
        options: [
          'Scheduled discard',
          'On-condition monitoring',
          'Failure-finding tasks',
        ...
        correctIndex: 2,
        explanation: 'Failure-finding tasks are periodic checks specifically designed to detect whether hidden functions are still working—like testing backup systems or safety devices that don\'t operate under normal conditions.',
      },
    ],
  },
  {
    id: 5,
    slug: 'implementing-rcm',
    title: 'Implementing RCM in Your Organisation',
    subtitle: 'Turning analysis into action—making RCM work in the real world',
    duration: '20-25 min',
    content: `
...
Congratulations on taking this step in your reliability journey. Now go make your equipment work better.
    `,
    keyTakeaways: [
      'Management commitment and clear objectives are prerequisites for successful RCM implementation',
      'Build cross-functional teams: operators, maintainers, engineers, and management',
      'Start with a moderately critical system—not the most complex or most trivial',
      'Analysis without implementation is wasted effort—ensure clear ownership of results',
      'RCM is a living process that needs feedback loops and periodic updates',
    ],
    quiz: [
      {
        question: 'What is typically the best choice for a first RCM analysis?',
        options: [
          'Your most critical, complex system',
          'A trivial, non-essential system',
          'A moderately critical system with known issues and engaged stakeholders',
          'Whatever management picks',
        ],
        correctIndex: 2,
        explanation: 'Start with something important enough to justify effort but not so complex or critical that you\'re overwhelmed. You want early success to build momentum and demonstrate value.',
      },
      {
        question: 'Who should be on an RCM analysis team?',
        options: [
          'Only engineers',
          'Only management',
          'A cross-functional team including operators, maintainers, engineers, and management',
          'Only the equipment manufacturer',
        ],
        correctIndex: 2,
        explanation: 'RCM requires diverse perspectives: operators know normal behaviour, maintainers know failure history, engineers provide technical depth, and management ensures business alignment.',
      },
      {
        question: 'What is "analysis paralysis" in RCM implementation?',
        options: [
          'Not enough analysis',
          'Spending so long on analysis that implementation never happens',
          'Analysing the wrong equipment',
          'Using the wrong software',
        ],
        correctIndex: 1,
        explanation: 'Analysis paralysis occurs when teams pursue perfect analysis indefinitely, losing momentum and enthusiasm before anything is implemented. Set time limits and accept "good enough."',
      },
      {
        question: 'Why is a feedback loop important for sustaining RCM?',
        options: [
          'It\'s required by regulations',
          'It generates reports for management',
          'It allows analyses to be updated as failures occur and conditions change',
          'It reduces paperwork',
        ],
        correctIndex: 2,
        explanation: 'RCM isn\'t static. Equipment ages, operating conditions change, and new failure modes emerge. A feedback mechanism ensures analyses remain relevant and tasks stay effective.',
      },
      {
        question: 'What should happen when RCM analysis identifies a task that already exists?',
        options: [
          'Add it again anyway',
          'Delete the existing task',
          'Compare and rationalise—modify frequency or scope if needed',
          'Ignore the RCM recommendation',
        ],
        correctIndex: 2,
        explanation: 'RCM often validates existing practices but may recommend different frequencies or scopes. Rationalise recommendations with current work to avoid duplication while ensuring tasks are optimised.',
      },
    ],
  },
];
