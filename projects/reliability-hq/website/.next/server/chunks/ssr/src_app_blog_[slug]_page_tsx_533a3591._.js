module.exports=[67932,a=>{"use strict";var b=a.i(7997),c=a.i(95936);a.i(70396);var d=a.i(73727);let e={"rcm-basics":"RCM Basics",implementation:"Implementation","case-studies":"Case Studies","industry-news":"Industry News"},f=[{slug:"what-is-rcm",title:"What is RCM? A Complete Guide for Maintenance Professionals",excerpt:"Everything you need to know about Reliability Centred Maintenance—its history, definition, the 7 questions, and how to apply it in your organisation.",category:"rcm-basics",author:"Reliability HQ",publishDate:"2026-01-15",readTime:12,featured:!0,metaDescription:"Learn what RCM (Reliability Centred Maintenance) is, its history from aviation to industry, the 7 RCM questions, SAE JA1011 compliance, and how to implement it effectively.",relatedSlugs:["7-rcm-questions-explained","rcm-vs-pm-optimization","fmea-step-by-step-guide"],content:`
## Introduction
...
`},{slug:"rcm-vs-pm-optimization",title:"RCM vs PM Optimisation: Which Approach is Right for You?",excerpt:"Comparing Reliability Centred Maintenance and PM Optimisation—understand the differences, pros and cons, and when to use each methodology.",category:"rcm-basics",author:"Reliability HQ",publishDate:"2026-01-20",readTime:10,featured:!1,metaDescription:"Compare RCM and PM Optimisation methodologies. Learn the key differences, advantages, disadvantages, and how to choose the right approach for your maintenance strategy.",relatedSlugs:["what-is-rcm","rcm-implementation-mistakes","7-rcm-questions-explained"],content:`
## Introduction
...
`},{slug:"7-rcm-questions-explained",title:"The 7 RCM Questions Explained with Practical Examples",excerpt:"A deep dive into each of the seven RCM questions with real-world examples from industrial equipment—pumps, motors, valves, and more.",category:"rcm-basics",author:"Reliability HQ",publishDate:"2026-01-25",readTime:15,featured:!0,metaDescription:"Master the 7 RCM questions with practical examples from industrial settings. Learn how to apply each question to pumps, motors, valves, and other equipment.",relatedSlugs:["what-is-rcm","fmea-step-by-step-guide","rcm-implementation-mistakes"],content:`
## Introduction
...
"High-pitched squealing noise heard from motor for 1-2 minutes before motor stops. Control room receives motor trip alarm. Standby pump starts automatically. No safety hazard. Production continues on standby pump. Repair requires motor removal to workshop for bearing replacement (2x 6205-2RS bearings, \xa340). Estimated repair time 4 hours with two fitters. Motor may need rewinding if operated while seized (additional \xa3800 and 2 weeks if sent away)."
...
Marginally — increased seal water consumption (~\xa35/week). Pump continues operating.
...
**Q4 — Failure Effect:**  
"Valve drives to fully open or closed regardless of control signal. Control room operator notices flow deviation alarm within 5 minutes. Manual control can be established via handwheel. Process upset may result in batch quality issue (\xa35,000 value). Reconnecting linkage takes 30 minutes, one technician."
...
`},{slug:"rcm-implementation-mistakes",title:"Common RCM Implementation Mistakes (And How to Avoid Them)",excerpt:"The top 10 mistakes organisations make when implementing RCM—and practical advice to ensure your programme succeeds.",category:"implementation",author:"Reliability HQ",publishDate:"2026-01-28",readTime:11,featured:!1,metaDescription:"Avoid the common RCM implementation mistakes that derail maintenance improvement programmes. Learn from real-world failures and practical solutions.",relatedSlugs:["what-is-rcm","7-rcm-questions-explained","rcm-vs-pm-optimization"],content:`
## Introduction
...
`},{slug:"fmea-step-by-step-guide",title:"How to Build an Effective FMEA: A Step-by-Step Guide",excerpt:"A practical tutorial for creating Failure Mode and Effects Analysis documentation—with templates, examples, and tips for common equipment.",category:"implementation",author:"Reliability HQ",publishDate:"2026-02-01",readTime:14,featured:!0,metaDescription:"Learn how to create effective FMEA documentation with this step-by-step guide. Includes practical examples, templates, and tips for industrial equipment analysis.",relatedSlugs:["what-is-rcm","7-rcm-questions-explained","rcm-implementation-mistakes"],content:`
## Introduction
...
| 4 | Indicate discharge pressure locally (gauge reading within \xb15% of actual) |
...
| 7 | Operate within acceptable temperature limits (bearing temp < 80\xb0C) |
...
"Motor makes increasing noise (high-pitched grinding) for approximately 24-48 hours before seizing. When bearing seizes, motor trips on overload. Control room receives motor trip alarm. Standby pump auto-starts. No safety or environmental impact. If detected early (on noise), bearing can be replaced in situ—4 hours, two fitters, \xa350 parts. If motor runs while seized, motor rewind required—remove motor, send to shop, 2 weeks, \xa31,200. No secondary equipment damage."
...
|----------|-------------------|--------------|----------------|
| 1. Transfer cooling water at 200 L/min at 5 bar | 1A. Unable to transfer any water | 1A.1 Motor bearing seized | Motor makes grinding noise 24-48 hrs before seizing. Motor trips on overload. Standby pump starts. 4 hr repair if detected early (\xa350), 2 weeks + \xa31,200 if motor damaged. |
| 1. Transfer cooling water at 200 L/min at 5 bar | 1A. Unable to transfer any water | 1A.2 Coupling failure | Sudden loss of flow. Motor continues running (no load). Control room sees flow alarm and motor amps drop. 2 hr repair, \xa3150 coupling. |
| 2. Contain water (<10 mL/hr leak) | 2A. External leak >10 mL/hr | 2A.1 Mechanical seal worn | Progressive increase in seal leak over weeks. Visible dripping. Pump continues operating. Seal replacement requires pump isolation, 3 hrs, \xa3280 seal kit. |
...
`}];function g(a){return f.find(b=>b.slug===a)}function h(){return f.map(a=>({slug:a.slug}))}function i({params:a}){return a.then(({slug:a})=>{let b=g(a);return b?{title:`${b.title} | Reliability HQ Blog`,description:b.metaDescription,openGraph:{title:b.title,description:b.metaDescription,type:"article",publishedTime:b.publishDate,authors:[b.author]}}:{title:"Article Not Found"}})}function j({title:a,slug:c}){let d=`https://reliabilityhq.com/blog/${c}`,e=encodeURIComponent(d),f=encodeURIComponent(a);return(0,b.jsxs)("div",{className:"flex items-center gap-3",children:[(0,b.jsx)("span",{className:"text-sm text-mid-grey",children:"Share:"}),(0,b.jsx)("a",{href:`https://twitter.com/intent/tweet?url=${e}&text=${f}`,target:"_blank",rel:"noopener noreferrer",className:"text-mid-grey hover:text-deep-teal transition-colors","aria-label":"Share on Twitter",children:(0,b.jsx)("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{d:"M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"})})}),(0,b.jsx)("a",{href:`https://www.linkedin.com/sharing/share-offsite/?url=${e}`,target:"_blank",rel:"noopener noreferrer",className:"text-mid-grey hover:text-deep-teal transition-colors","aria-label":"Share on LinkedIn",children:(0,b.jsx)("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{d:"M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"})})}),(0,b.jsx)("a",{href:`mailto:?subject=${f}&body=Check out this article: ${d}`,className:"text-mid-grey hover:text-deep-teal transition-colors","aria-label":"Share via email",children:(0,b.jsx)("svg",{className:"w-5 h-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})})})]})}function k({article:a}){return a?(0,b.jsx)(c.default,{href:`/blog/${a.slug}`,className:"group block",children:(0,b.jsxs)("article",{className:"bg-white rounded-lg p-4 hover:shadow-md transition-shadow",children:[(0,b.jsx)("span",{className:"text-xs font-semibold text-deep-teal bg-deep-teal/10 px-2 py-0.5 rounded",children:e[a.category]}),(0,b.jsx)("h4",{className:"font-heading font-semibold text-slate-navy group-hover:text-deep-teal transition-colors mt-2 mb-2 line-clamp-2",children:a.title}),(0,b.jsxs)("p",{className:"text-sm text-mid-grey",children:[a.readTime," min read"]})]})}):null}function l({headings:a}){return 0===a.length?null:(0,b.jsxs)("nav",{className:"bg-white rounded-xl p-6 shadow-sm",children:[(0,b.jsx)("h3",{className:"font-heading font-semibold text-slate-navy mb-4",children:"Table of Contents"}),(0,b.jsx)("ul",{className:"space-y-2",children:a.map(a=>(0,b.jsx)("li",{className:3===a.level?"ml-4":"",children:(0,b.jsx)("a",{href:`#${a.id}`,className:"text-sm text-mid-grey hover:text-deep-teal transition-colors block py-1",children:a.text})},a.id))})]})}async function m({params:a}){let f,{slug:h}=await a,i=g(h);i||(0,d.notFound)();let m=(f=g(h))?f.relatedSlugs.map(a=>g(a)).filter(a=>void 0!==a):[],n=function(a){let b,c=/^(#{2,3})\s+(.+)$/gm,d=[];for(;null!==(b=c.exec(a));){let a=b[1].length,c=b[2],e=c.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"");d.push({id:e,text:c,level:a})}return d}(i.content),o=i.content.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n\|(.+)\|\n\|[-:|]+\|\n((?:\|.+\|\n?)+)/g,(a,b,c)=>{let d=b.split("|").map(a=>a.trim()).filter(Boolean).map(a=>`<th class="px-4 py-3 text-left text-sm font-semibold text-slate-navy border-b-2 border-deep-teal">${a}</th>`).join(""),e=c.trim().split("\n").map(a=>{let b=a.split("|").map(a=>a.trim()).filter(Boolean);return`<tr class="border-b border-light-grey hover:bg-off-white">${b.map(a=>`<td class="px-4 py-3 text-sm">${a}</td>`).join("")}</tr>`}).join("");return`<div class="overflow-x-auto my-6"><table class="w-full border-collapse bg-white rounded-lg overflow-hidden shadow-sm"><thead class="bg-light-grey">${d}</thead><tbody>${e}</tbody></table></div>`}).replace(/^### (.+)$/gm,(a,b)=>{let c=b.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"");return`<h3 id="${c}" class="font-heading font-semibold text-xl text-slate-navy mt-10 mb-4 scroll-mt-20">${b}</h3>`}).replace(/^## (.+)$/gm,(a,b)=>{let c=b.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"");return`<h2 id="${c}" class="font-heading font-bold text-2xl text-slate-navy mt-12 mb-6 scroll-mt-20">${b}</h2>`}).replace(/^---$/gm,'<hr class="my-12 border-t-2 border-light-grey" />').replace(/\*\*\*(.+?)\*\*\*/g,"<strong><em>$1</em></strong>").replace(/\*\*(.+?)\*\*/g,'<strong class="font-semibold text-slate-navy">$1</strong>').replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/\[([^\]]+)\]\((\/[^)]+)\)/g,'<a href="$2" class="text-deep-teal hover:text-slate-navy underline decoration-deep-teal/30 hover:decoration-deep-teal transition-colors">$1</a>').replace(/(?:^|\n)((?:- .+\n?)+)/g,(a,b)=>{let c=b.trim().split("\n").map(a=>{let b=a.replace(/^- /,"");return`<li class="flex items-start gap-2"><span class="text-deep-teal mt-1.5">•</span><span>${b}</span></li>`}).join("");return`<ul class="space-y-2 my-6 pl-1">${c}</ul>`}).replace(/(?:^|\n)((?:\d+\. .+\n?)+)/g,(a,b)=>{let c=b.trim().split("\n").map((a,b)=>{let c=a.replace(/^\d+\. /,"");return`<li class="flex items-start gap-3"><span class="text-deep-teal font-semibold min-w-[1.5rem]">${b+1}.</span><span>${c}</span></li>`}).join("");return`<ol class="space-y-2 my-6">${c}</ol>`}).replace(/```(\w*)\n([\s\S]*?)```/g,'<pre class="bg-slate-navy text-white p-4 rounded-lg overflow-x-auto my-6 text-sm"><code>$2</code></pre>').replace(/`([^`]+)`/g,'<code class="bg-light-grey text-slate-navy px-1.5 py-0.5 rounded text-sm font-mono">$1</code>').replace(/^&gt; (.+)$/gm,'<blockquote class="border-l-4 border-deep-teal pl-4 my-6 text-charcoal italic">$1</blockquote>').replace(/\n\n([^<\n][^\n]+)\n\n/g,'\n\n<p class="text-charcoal leading-relaxed mb-6">$1</p>\n\n').replace(/\n\n([^<\n][^\n]+)$/g,'\n\n<p class="text-charcoal leading-relaxed mb-6">$1</p>');return(0,b.jsxs)("div",{className:"bg-off-white",children:[(0,b.jsx)("header",{className:"bg-gradient-to-br from-slate-navy to-deep-teal text-white py-12 md:py-16",children:(0,b.jsx)("div",{className:"container-max px-4 sm:px-6 lg:px-8",children:(0,b.jsxs)("div",{className:"max-w-4xl",children:[(0,b.jsxs)("nav",{className:"flex items-center gap-2 text-sm text-white/60 mb-6",children:[(0,b.jsx)(c.default,{href:"/",className:"hover:text-white transition-colors",children:"Home"}),(0,b.jsx)("span",{children:"/"}),(0,b.jsx)(c.default,{href:"/blog",className:"hover:text-white transition-colors",children:"Blog"}),(0,b.jsx)("span",{children:"/"}),(0,b.jsx)("span",{className:"text-white/80",children:e[i.category]})]}),(0,b.jsx)("span",{className:"inline-block text-sm font-semibold bg-white/20 px-3 py-1 rounded-full mb-4",children:e[i.category]}),(0,b.jsx)("h1",{className:"font-heading font-bold text-3xl md:text-4xl lg:text-5xl mb-6",children:i.title}),(0,b.jsxs)("div",{className:"flex flex-wrap items-center gap-4 text-white/80",children:[(0,b.jsxs)("span",{className:"flex items-center gap-2",children:[(0,b.jsx)("svg",{className:"w-5 h-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"})}),i.author]}),(0,b.jsxs)("span",{className:"flex items-center gap-2",children:[(0,b.jsx)("svg",{className:"w-5 h-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"})}),new Date(i.publishDate).toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"})]}),(0,b.jsxs)("span",{className:"flex items-center gap-2",children:[(0,b.jsx)("svg",{className:"w-5 h-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),i.readTime," min read"]})]})]})})}),(0,b.jsxs)("div",{className:"container-max px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsxs)("div",{className:"lg:flex lg:gap-12",children:[(0,b.jsx)("aside",{className:"hidden lg:block lg:w-72 flex-shrink-0",children:(0,b.jsxs)("div",{className:"sticky top-24",children:[(0,b.jsx)(l,{headings:n}),(0,b.jsx)("div",{className:"mt-6 bg-white rounded-xl p-6 shadow-sm",children:(0,b.jsx)(j,{title:i.title,slug:i.slug})})]})}),(0,b.jsxs)("article",{className:"flex-grow max-w-3xl",children:[(0,b.jsx)("div",{className:"lg:hidden mb-8 p-4 bg-white rounded-lg shadow-sm",children:(0,b.jsx)(j,{title:i.title,slug:i.slug})}),(0,b.jsx)("div",{className:"prose prose-lg max-w-none",dangerouslySetInnerHTML:{__html:o}}),(0,b.jsxs)("div",{className:"mt-12 bg-gradient-to-br from-deep-teal to-slate-navy rounded-xl p-8 text-white",children:[(0,b.jsx)("h3",{className:"font-heading font-bold text-2xl mb-4",children:"Ready to Improve Your Maintenance Programme?"}),(0,b.jsx)("p",{className:"text-white/80 mb-6",children:"Our professionally designed RCM templates and tools help you implement reliability best practices efficiently."}),(0,b.jsxs)("div",{className:"flex flex-wrap gap-4",children:[(0,b.jsx)(c.default,{href:"/products",className:"inline-block bg-industrial-amber hover:bg-industrial-amber/90 text-white font-semibold px-6 py-3 rounded-lg transition-colors",children:"Browse Products"}),(0,b.jsx)(c.default,{href:"/resources",className:"inline-block bg-white/20 hover:bg-white/30 text-white font-semibold px-6 py-3 rounded-lg transition-colors",children:"Free Tools"})]})]}),(0,b.jsxs)("div",{className:"mt-12 bg-white rounded-xl p-6 shadow-sm flex items-start gap-4",children:[(0,b.jsx)("div",{className:"w-16 h-16 bg-deep-teal/10 rounded-full flex items-center justify-center flex-shrink-0",children:(0,b.jsx)("span",{className:"text-deep-teal font-heading font-bold text-xl",children:"R"})}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h4",{className:"font-heading font-semibold text-slate-navy",children:i.author}),(0,b.jsx)("p",{className:"text-mid-grey text-sm mt-1",children:"Sharing practical reliability engineering knowledge to help maintenance professionals implement RCM effectively. Based on SAE JA1011 standards and real-world experience."})]})]})]})]}),m.length>0&&(0,b.jsxs)("section",{className:"mt-16",children:[(0,b.jsx)("h2",{className:"font-heading font-bold text-2xl text-slate-navy mb-6",children:"Related Articles"}),(0,b.jsx)("div",{className:"grid md:grid-cols-3 gap-6",children:m.map(a=>(0,b.jsx)(k,{article:a},a.slug))})]}),(0,b.jsxs)("section",{className:"mt-16 bg-light-grey rounded-2xl p-8 md:p-12 text-center",children:[(0,b.jsx)("h2",{className:"font-heading font-bold text-2xl text-slate-navy mb-4",children:"Get More RCM Insights"}),(0,b.jsx)("p",{className:"text-charcoal mb-6 max-w-2xl mx-auto",children:"Subscribe to receive new articles, guides, and practical tips for reliability engineering professionals."}),(0,b.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto",children:[(0,b.jsx)("input",{type:"email",placeholder:"Enter your email",className:"flex-grow px-4 py-3 border border-mid-grey rounded-lg focus:ring-2 focus:ring-deep-teal focus:border-transparent outline-none"}),(0,b.jsx)("button",{className:"bg-deep-teal hover:bg-slate-navy text-white font-semibold px-6 py-3 rounded-lg transition-colors",children:"Subscribe"})]})]})]})]})}a.s(["default",()=>m,"generateMetadata",()=>i,"generateStaticParams",()=>h],67932)}];

//# sourceMappingURL=src_app_blog_%5Bslug%5D_page_tsx_533a3591._.js.map