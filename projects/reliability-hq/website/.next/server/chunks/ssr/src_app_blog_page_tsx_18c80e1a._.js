module.exports=[17262,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(38246);let e={"rcm-basics":"RCM Basics",implementation:"Implementation","case-studies":"Case Studies","industry-news":"Industry News"},f=[{slug:"what-is-rcm",title:"What is RCM? A Complete Guide for Maintenance Professionals",excerpt:"Everything you need to know about Reliability Centred Maintenance—its history, definition, the 7 questions, and how to apply it in your organisation.",category:"rcm-basics",author:"Reliability HQ",publishDate:"2026-01-15",readTime:12,featured:!0,metaDescription:"Learn what RCM (Reliability Centred Maintenance) is, its history from aviation to industry, the 7 RCM questions, SAE JA1011 compliance, and how to implement it effectively.",relatedSlugs:["7-rcm-questions-explained","rcm-vs-pm-optimization","fmea-step-by-step-guide"],content:`
## Introduction
...
`}];function g(a){return new Date(a).toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"})}let h=["all","rcm-basics","implementation","case-studies","industry-news"];function i({article:a}){return(0,b.jsx)(d.default,{href:`/blog/${a.slug}`,className:"group",children:(0,b.jsxs)("article",{className:"bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden h-full flex flex-col",children:[(0,b.jsx)("div",{className:"h-48 bg-gradient-to-br from-deep-teal/10 to-slate-navy/10 flex items-center justify-center",children:(0,b.jsx)("div",{className:"text-deep-teal/30",children:(0,b.jsx)("svg",{className:"w-16 h-16",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1,d:"M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"})})})}),(0,b.jsxs)("div",{className:"p-6 flex flex-col flex-grow",children:[(0,b.jsx)("span",{className:"inline-block text-xs font-semibold text-deep-teal bg-deep-teal/10 px-2 py-1 rounded mb-3 self-start",children:e[a.category]}),(0,b.jsx)("h3",{className:"font-heading font-semibold text-lg text-slate-navy group-hover:text-deep-teal transition-colors mb-2",children:a.title}),(0,b.jsx)("p",{className:"text-mid-grey text-sm mb-4 flex-grow",children:a.excerpt}),(0,b.jsxs)("div",{className:"flex items-center justify-between text-xs text-mid-grey border-t border-light-grey pt-4",children:[(0,b.jsx)("span",{children:g(a.publishDate)}),(0,b.jsxs)("span",{children:[a.readTime," min read"]})]})]})]})})}function j({article:a}){return(0,b.jsx)(d.default,{href:`/blog/${a.slug}`,className:"group block",children:(0,b.jsx)("article",{className:"bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden",children:(0,b.jsxs)("div",{className:"md:flex",children:[(0,b.jsx)("div",{className:"md:w-2/5 h-64 md:h-auto bg-gradient-to-br from-deep-teal/20 to-slate-navy/20 flex items-center justify-center",children:(0,b.jsx)("div",{className:"text-deep-teal/40",children:(0,b.jsx)("svg",{className:"w-24 h-24",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1,d:"M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"})})})}),(0,b.jsxs)("div",{className:"md:w-3/5 p-6 md:p-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-3 mb-4",children:[(0,b.jsx)("span",{className:"inline-block text-xs font-semibold text-industrial-amber bg-industrial-amber/10 px-2 py-1 rounded",children:"Featured"}),(0,b.jsx)("span",{className:"inline-block text-xs font-semibold text-deep-teal bg-deep-teal/10 px-2 py-1 rounded",children:e[a.category]})]}),(0,b.jsx)("h2",{className:"font-heading font-bold text-2xl md:text-3xl text-slate-navy group-hover:text-deep-teal transition-colors mb-4",children:a.title}),(0,b.jsx)("p",{className:"text-charcoal mb-6",children:a.excerpt}),(0,b.jsxs)("div",{className:"flex items-center gap-4 text-sm text-mid-grey",children:[(0,b.jsx)("span",{children:g(a.publishDate)}),(0,b.jsx)("span",{children:"•"}),(0,b.jsxs)("span",{children:[a.readTime," min read"]})]})]})]})})})}function k(){let[a,d]=(0,c.useState)("all"),[g,k]=(0,c.useState)(""),l=f.find(a=>a.featured),m=(0,c.useMemo)(()=>f.filter(b=>{if("all"!==a&&b.category!==a)return!1;if(g.trim()){let a=g.toLowerCase(),c=b.title.toLowerCase().includes(a),d=b.excerpt.toLowerCase().includes(a),f=e[b.category].toLowerCase().includes(a);if(!c&&!d&&!f)return!1}return!0}),[a,g]).filter(b=>!b.featured||"all"!==a||g);return(0,b.jsxs)("div",{className:"bg-off-white",children:[(0,b.jsx)("section",{className:"bg-gradient-to-br from-slate-navy to-deep-teal text-white py-16 md:py-20",children:(0,b.jsx)("div",{className:"container-max px-4 sm:px-6 lg:px-8",children:(0,b.jsxs)("div",{className:"max-w-3xl",children:[(0,b.jsx)("h1",{className:"font-heading font-bold text-4xl md:text-5xl mb-4",children:"RCM Insights & Guides"}),(0,b.jsx)("p",{className:"text-xl text-white/80",children:"Practical articles on Reliability Centred Maintenance—written by practitioners, for practitioners."})]})})}),(0,b.jsxs)("div",{className:"container-max px-4 sm:px-6 lg:px-8 py-12",children:[(0,b.jsxs)("div",{className:"mb-10",children:[(0,b.jsx)("div",{className:"mb-6",children:(0,b.jsxs)("div",{className:"relative max-w-md",children:[(0,b.jsx)("input",{type:"text",placeholder:"Search articles...",value:g,onChange:a=>k(a.target.value),className:"w-full pl-10 pr-4 py-3 border border-light-grey rounded-lg focus:ring-2 focus:ring-deep-teal focus:border-transparent outline-none"}),(0,b.jsx)("svg",{className:"absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-mid-grey",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})})]})}),(0,b.jsx)("div",{className:"flex flex-wrap gap-2",children:h.map(c=>(0,b.jsx)("button",{onClick:()=>d(c),className:`px-4 py-2 rounded-full text-sm font-medium transition-colors ${a===c?"bg-deep-teal text-white":"bg-white text-charcoal hover:bg-light-grey"}`,children:"all"===c?"All Articles":e[c]},c))})]}),l&&"all"===a&&!g&&(0,b.jsx)("div",{className:"mb-12",children:(0,b.jsx)(j,{article:l})}),m.length>0?(0,b.jsx)("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-8",children:m.map(a=>(0,b.jsx)(i,{article:a},a.slug))}):(0,b.jsxs)("div",{className:"text-center py-16",children:[(0,b.jsx)("div",{className:"text-mid-grey mb-4",children:(0,b.jsx)("svg",{className:"w-16 h-16 mx-auto",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1,d:"M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})})}),(0,b.jsx)("h3",{className:"font-heading font-semibold text-xl text-slate-navy mb-2",children:"No articles found"}),(0,b.jsx)("p",{className:"text-mid-grey",children:"Try adjusting your search or filter criteria."})]}),(0,b.jsxs)("section",{className:"mt-16 bg-gradient-to-br from-deep-teal to-slate-navy rounded-2xl p-8 md:p-12 text-white text-center",children:[(0,b.jsx)("h2",{className:"font-heading font-bold text-2xl md:text-3xl mb-4",children:"Stay Updated on RCM Best Practices"}),(0,b.jsx)("p",{className:"text-white/80 mb-6 max-w-2xl mx-auto",children:"Get practical reliability engineering insights delivered to your inbox. No spam—just useful content for maintenance professionals."}),(0,b.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto",children:[(0,b.jsx)("input",{type:"email",placeholder:"Enter your email",className:"flex-grow px-4 py-3 rounded-lg text-charcoal focus:ring-2 focus:ring-industrial-amber outline-none"}),(0,b.jsx)("button",{className:"bg-industrial-amber hover:bg-industrial-amber/90 text-white font-semibold px-6 py-3 rounded-lg transition-colors",children:"Subscribe"})]})]})]})]})}a.s(["default",()=>k],17262)}];
